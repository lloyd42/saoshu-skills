...
function usage() {
  console.log("Usage: node db_dashboard.mjs --db <dir> --output <dashboard.html> [--compare-presets default,context-audit,context-source] [--compare-top 20] [--skip-compare]");
}
...
function main() {
  ...
  const compareCardHint = args.skipCompare
    ...
    : "dashboard 会自动补齐缺失或过期的 compare 详情页；如果目录里已有自定义 compare 产物，则直接保留并链接，不主动覆盖。自动补齐失败时仍显示命令兜底。默认 coverage-first 主线继续保留，context-audit / context-source 只在你明确需要时再加。";
